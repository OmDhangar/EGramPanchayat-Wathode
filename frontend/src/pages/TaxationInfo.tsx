...
import { FileText, ExternalLink, User, Phone, Mail, Hash, Building, MapPin, Tag } from 'lucide-react';
...
ग्रामनिधी स्कॅनर</h3>
      ...
      <div className="flex flex-col items-center">
        <img
          ...
          className="w-56 h-56 object-contain rounded-lg transition-transform duration-300 hover:scale-105"
          onError={(e) => {
